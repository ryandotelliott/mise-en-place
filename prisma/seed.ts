...
async function main() {
  ...
  const garlicButterSalmon = await db.recipe.create({
    data: {
      ...
      ingredients: {
        create: [
          { quantity: 2, unit: "fillet", name: "Salmon fillets", category: "SEAFOOD", notes: "6 oz each" },
          { quantity: 3, unit: "tbsp", name: "Butter", category: "DAIRY" },
          { quantity: 4, unit: "clove", name: "Garlic", category: "PRODUCE", notes: "minced" },
          { quantity: 1, unit: "tbsp", name: "Olive oil", category: "PANTRY" },
          { quantity: 1, unit: "whole", name: "Lemon", category: "PRODUCE", notes: "juiced" },
          { quantity: 2, unit: "tbsp", name: "Fresh parsley", category: "PRODUCE", notes: "chopped" },
        ],
      },
    },
  });
  ...
  const chickenTikkaMasala = await db.recipe.create({
    data: {
      ...
      ingredients: {
        create: [
          { quantity: 1.5, unit: "lb", name: "Chicken breast", category: "MEAT", notes: "cubed" },
          { quantity: 1, unit: "cup", name: "Yogurt", category: "DAIRY" },
          { quantity: 2, unit: "tbsp", name: "Tikka masala spice", category: "PANTRY" },
          { quantity: 1, unit: "can", name: "Crushed tomatoes", category: "PANTRY" },
          { quantity: 1, unit: "cup", name: "Heavy cream", category: "DAIRY" },
          { quantity: 1, unit: "whole", name: "Onion", category: "PRODUCE", notes: "diced" },
          { quantity: 4, unit: "clove", name: "Garlic", category: "PRODUCE", notes: "minced" },
          { quantity: 2, unit: "tbsp", name: "Fresh cilantro", category: "PRODUCE" },
        ],
      },
    },
  });
  ...
  const mushroomRisotto = await db.recipe.create({
    data: {
      ...
      ingredients: {
        create: [
          { quantity: 1.5, unit: "cup", name: "Arborio rice", category: "PANTRY" },
          { quantity: 8, unit: "oz", name: "Mixed mushrooms", category: "PRODUCE", notes: "sliced" },
          { quantity: 4, unit: "cup", name: "Chicken stock", category: "PANTRY", notes: "warm" },
          { quantity: 0.5, unit: "cup", name: "White wine", category: "PANTRY" },
          { quantity: 0.5, unit: "cup", name: "Parmesan", category: "DAIRY", notes: "grated" },
          { quantity: 2, unit: "tbsp", name: "Butter", category: "DAIRY" },
          { quantity: 1, unit: "whole", name: "Shallot", category: "PRODUCE", notes: "minced" },
          { quantity: 1, unit: "tbsp", name: "Fresh thyme", category: "PRODUCE" },
        ],
      },
    },
  });
  ...
  const thaiGreenCurry = await db.recipe.create({
    data: {
      ...
      ingredients: {
        create: [
          { quantity: 1, unit: "lb", name: "Chicken thigh", category: "MEAT", notes: "sliced" },
          { quantity: 2, unit: "tbsp", name: "Green curry paste", category: "PANTRY" },
          { quantity: 1, unit: "can", name: "Coconut milk", category: "PANTRY" },
          { quantity: 1, unit: "cup", name: "Mixed vegetables", category: "PRODUCE" },
          { quantity: 1, unit: "tbsp", name: "Fish sauce", category: "PANTRY" },
          { quantity: 1, unit: "tbsp", name: "Brown sugar", category: "PANTRY" },
          { quantity: 0.5, unit: "cup", name: "Fresh basil", category: "PRODUCE" },
          { quantity: 2, unit: "cup", name: "Jasmine rice", category: "PANTRY" },
        ],
      },
    },
  });
  ...
  const mediterraneanQuinoaBowl = await db.recipe.create({
    data: {
      ...
      description: "Healthy grain bowl with chickpeas, feta, and fresh vegetables",
      servings: 2,
      prepTime: 15,
      cookTime: 20,
      difficulty: "EASY",
      ...
      ingredients: {
        create: [
          ...
          { quantity: 1, unit: "can", name: "Chickpeas", category: "PANTRY", notes: "drained" },
          { quantity: 1, unit: "whole", name: "Cucumber", category: "PRODUCE", notes: "diced" },
          { quantity: 1, unit: "cup", name: "Cherry tomatoes", category: "PRODUCE", notes: "halved" },
          { quantity: 0.5, unit: "cup", name: "Feta cheese", category: "DAIRY" },
          { quantity: 0.25, unit: "cup", name: "Kalamata olives", category: "PANTRY" },
  ...
  const oatmealWithBerries = await db.recipe.create({
    data: {
      ...
      ingredients: {
        create: [
          { quantity: 0.5, unit: "cup", name: "Rolled oats", category: "PANTRY" },
          { quantity: 1, unit: "cup", name: "Milk", category: "DAIRY" },
          { quantity: 0.5, unit: "cup", name: "Mixed berries", category: "PRODUCE" },
  ...
  const grilledChickenSalad = await db.recipe.create({
    data: {
      ...
      ingredients: {
        create: [
          { quantity: 1, unit: "whole", name: "Chicken breast", category: "MEAT" },
          { quantity: 2, unit: "cup", name: "Mixed greens", category: "PRODUCE" },
          { quantity: 0.5, unit: "cup", name: "Cherry tomatoes", category: "PRODUCE" },
          { quantity: 0.5, unit: "whole", name: "Cucumber", category: "PRODUCE", notes: "sliced" },
          { quantity: 2, unit: "tbsp", name: "Balsamic dressing", category: "PANTRY" },
        ],
      },
    },
  });
  ...
  const turkeyWrap = await db.recipe.create({
    data: {
      ...
      ingredients: {
        create: [
          { quantity: 1, unit: "whole", name: "Large tortilla", category: "BAKERY" },
  ...
  const avocadoToast = await db.recipe.create({
    data: {
      ...
      ingredients: {
        create: [
          { quantity: 2, unit: "slice", name: "Sourdough bread", category: "BAKERY" },
          { quantity: 1, unit: "whole", name: "Avocado", category: "PRODUCE" },
          { quantity: 1, unit: "tsp", name: "Everything bagel seasoning", category: "PANTRY" },
          { quantity: 0.25, unit: "tsp", name: "Red pepper flakes", category: "PANTRY" },
        ],
      },
    },
  });
